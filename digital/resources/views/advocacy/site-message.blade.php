<x-app-layout>
    ...
    <div class="flex antialiased ">
        ...
        <div class="bg-darkalaa p-48 mr-48 top-1/2 left-1/2">
            ...
            <h2 class="text-2xl text-white">We are really sorry for the problem you encountered! Don't worry dear, we are all exposed to 
            ...
            <br>
                ...
                <span class="font-bold"> is a very unfair teacher. First it tests us, then it teaches</span> <br>
