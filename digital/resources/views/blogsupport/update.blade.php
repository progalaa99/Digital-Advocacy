<x-app-layout>
    ...
    <div class="bg-darkalaa p-4 w-3/2   flex justify-center items-center h-screen">
        <form class="flex flex-col items-center left-1/2 top-1/2  w-1/2 pt-10 "
            action="{{ route('blogsupport.update', ['blogsupportid' => $blogsupport->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <label class="block  text-gray-700 font-bold mb-2   w-full h-128">
                ...
                <input type="text" name="title" value="{{$blogsupport->title}}"
            ...
            <label class="block text-gray-700 font-bold mb-2   w-full h-128">
                ...
                <textarea type="text" name="body" value="{{$blogsupport->body}}" class="border-gray-400 border rounded py-2 px-3 w-full h-64">{{$blogsupport->body}}</textarea>
            ...
            <label class="block p-2 flex-col items-center ">
                ...
                <input type="file" name="cover" value="{{$blogsupport->cover}}"
